...
$sql = " SELECT * FROM tiim_admin WHERE email = '".$_POST['forgot_password']."'";

$result = mysql_query($sql) or die(mysql_error());

while ($row = mysql_fetch_assoc($result)) {
	sendMail_admin_forgot_password($_POST['forgot_password'],$row['pwd']) or die("ERROR Can not sent email to you.");
	echo '<p>Password already send to you, please check your e-mail.</p>';
}

echo '<p><br><a herf="index.php" onclick="window.history.go(-1)"><input type="submit" value="Go Back" /></a></p>';
