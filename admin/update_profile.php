                    ...
                    <td><ul id="main_menu">
                      ...
                      <li class="li_title">E-Registration<br />
                        <ul>
						  ...
						  <li class="li_sub"><a href="index.php">Administrator</a></li>
...
<table width="100%" cellspacing=0>
	<tr>
		<td align="left" class="h2"><span class="style1">Update Your Profile</span></td>
...
$sql = " UPDATE tiim_user SET status='".trim($_POST['status'])."' , first_name='".trim($_POST['first_name'])."',  last_name='".trim($_POST['last_name'])."',  title='".trim($_POST['title'])."' , institution='".trim($_POST['institution'])."' , address='".trim($_POST['address'])."' , city='".trim($_POST['city'])."' , postal_code='".trim($_POST['postal_code'])."' , state_province='".trim($_POST['state_province'])."',  country='".trim($_POST['country'])."',  phone='".trim($_POST['phone'])."' , fax='".trim($_POST['fax'])."'  WHERE email = '".$username."' ";

$result = mysql_query($sql) or die(mysql_error());

echo '<p>Update your profile success.</p>';
