		 ...
		 <form name="myform" method="post" action="upload.php" enctype="multipart/form-data" onsubmit="return checkk(this)">		
                ...
                <div id="main_content">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_td">
					...
					<script language=javascript>
					var a=250; //set the value of first textbox.
					var b=325; //set the value of second textbox.
					...
					if(frm.chk5.checked==true)
					  ...
					  if(frm.chk2.checked || frm.chk3.checked || frm.chk4.checked ==true)
					  {
						//x=parseInt(a);
						//y=parseInt(b);
						//z=parseInt(c);						
						sum=0;
						if(frm.quantity.selectedIndex!=0){
							sum_reg=frm.quantity.selectedIndex*(w);
							//alert("Regular: "+sum_reg);
						} else {
							//sum=0;
							frm.amount.value=sum_reg;
						}
						if(frm.acc_quantity.selectedIndex!=0){
					...
					Regular Registration Fee <span class="emp_text">(US$325)</span><br>
					<script language="javascript">					
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_td">
					...
					if(frm.chk5.checked==true)
					  ...
					  if(frm.chk1.checked || frm.chk2.checked || frm.chk3.checked || frm.chk4.checked ==true)
					  {
						...
						/*
						if(frm.quantity.selectedIndex!=0){
							//sum_reg=frm.quantity.selectedIndex*(v);
							sum_reg=v;
							alert("Early: "+sum_reg);
						} else {
							//sum=0;
