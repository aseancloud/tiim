                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_td">
					...
					if(frm.chk5.checked==true)
					  ...
					  if(frm.chk1.checked || frm.chk2.checked || frm.chk3.checked || frm.chk4.checked || frm.chk5.checked || frm.chk6.checked || frm.chk7.checked ==true)
					  {
						...
						sum = sum_reg+sum_acc+y+10+s+t+u;
						//alert("Sum: "+sum);
						if(sum>0){						
						//sum = sum+y;
						//alert(sum);
...
<img src="../images/spacer.gif" width="20" height="1" /><br />
					...
					<br>
					<input type="checkbox" name="chk5" onClick="app()">
					...
					<input type="checkbox" name="chk6" onClick="app()">
					...
					<input type="checkbox" name="chk7" onClick="app()">
...
(Only for Suvarnabhumi Int. Airport to Pattaya)<br />
				...
				<? if($method==3){
						...
						$q_ins_pay = "INSERT INTO tiim_payment_user (register_name, ORDERNUMBER, created_date) VALUES ('".$my_username."', '".$order_id."', '$day')";
				...
				<form action="https://www.krungsriepay.com/webapp/PaymentManager/PaymentInput " method="post" name="frm" onsubmit="return checkvisa(this)">
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="search_td">
                    ...
                    <tr>
                      <td class="field_label">Email address:</td>
                      <td><input name="REF1" type="text" id="REF1" size="30" value="<? echo $my_username;?>" /></td>
                    </tr>
					<tr>
