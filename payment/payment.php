...
*/
if ($error==1) {
	die('<br><a herf="payment.html" onclick="window.history.go(-1)"><input type="submit" value="Go Back" /></a>');
}
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><input name="firstName" type="text" id="firstName" size="30" />
                        <span class="field_required">* required</span>
                        <span class="form_hint">(example: John)</span></td>
                    </tr>
                    <tr>
                      <td class="field_label">Last name:</td>
                      <td><input name="lastName" type="text" id="lastName" size="30" />
                        <span class="field_required">* required</span> <span class="form_hint">(example: Smith)</span></td>
                    </tr>
                    <tr>
                      <td class="field_label">Email address:</td>
                      <td><input name="email" type="text" id="email" size="30" />
                        <span class="field_required">* required</span> <span class="form_hint">(will be your username)</span></td>
                    </tr>
                    <tr>
                      <td class="field_label">&nbsp;</td>
                      <td><img src="images/btn_submit.png" width="74" height="28" vspace="5" onClick="document.myform.submit();"/> <img src="images/btn_reset.png" width="74" height="28" vspace="5" /></td>
                    </tr>
                  </table>
                </div>
				</form>	
