            ...
            <td width="560" align="left" valign="top" bgcolor="#ffffff">
              ...
              <tr>
                ...
                <div id="main_content">				
                  ...
                  <table width="100%" border="0" class="payment_content">
                    <tr>
                      <td><strong>Major Credit card (Visa, Master and JCB) </strong><br />
                        <br />
                        Your Payment result from Major Credit card (Visa, Master and JCB)<br />
						
					<br />
					
                    <table width="90%" border="0" align="center">
                      <tr>
                        <td width="26%"><strong>Register Email:</strong></td>
                        <td width="74%"><? echo $_GET["REF1"];?></td>
                      </tr>
                      <tr>
                        <td><strong>Response:</strong></td>
                        <td>
						<? 
							$rescode =  $_GET["RESPCODE"];
							if($rescode=="00"){
								echo "SUCCESS";
							}
							if($rescode=="99"){
