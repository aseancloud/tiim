...
<table width="100%" cellspacing=0>
	<tr>
		<td align="left" class="h2"><span class="style1">Delete Your  Papers</span></td>
...
*/
if($abs==1){
$sql = " UPDATE tiim_abstract_paper SET active='0' WHERE id='".$id."' AND ref_id='".$ref_id."' ";

//echo $sql;

$result = mysql_query($sql) or die(mysql_error());

echo '<p>Already delete document.</p>';
echo '<p><br><a herf="main.php" onclick="window.history.go(-1)"><input type="submit" value="Go Back" /></a></p>';

}
if($full==1){
$sql = " UPDATE tiim_full_paper SET active='0' WHERE id='".$id."' AND ref_id='".$ref_id."' ";

$result = mysql_query($sql) or die(mysql_error());

echo '<p>Already delete document status.</p>';
...
if($del_co==1){
//echo $id ;
$sql = " DELETE FROM tiim_co_author  WHERE id='".$id."' ";

//echo $sql ;
$result = mysql_query($sql) or die(mysql_error());

echo '<p>Already delete Co_author status.</p>';
//แก้ไข 18/02/53
echo "<script>window.close()</script>"; 
//echo '<p><br><a herf="main.php"><input type="submit" value="Go Back"  onclick="window.history.go(-1)"/></a></p>';
//<a herf="main.php"><input type="submit" value="Go Back" onclick="window.history.go(-1)"/>
