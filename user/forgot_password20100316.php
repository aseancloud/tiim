...
$sql = " SELECT * FROM tiim_user WHERE email = '".$_POST['forgot_password']."'";

$result = mysql_query($sql) or die(mysql_error());
$num_rows = mysql_num_rows($result);

if($num_rows>0){
sendMail_forgot_password($_POST['forgot_password'],$row['pwd']) or die("ERROR Can not sent email to you.");
	echo '<p>Password already send to you, please check your e-mail.	
If you do not receive e-mail, <br/>please look into your junk mail box: 
If you can not find it at all, please contact   fengpta@ku.ac.th</p>';
}
else { 
echo '<p>Your email is not registered yet (Click here to registered). Or if you are certain that your email has been registered, please contact   fengpta@ku.ac.th </p>';
}
...
If you can not find it at all, please contact   fengpta@ku.ac.th</p>';
	...
	echo '<p><br><a herf="index.php"><input type="submit" value="Go Back" onclick="window.history.go(-1)"/></a></p>';



//echo '<p><br><a herf="index.php"> Go Back </a></p>';
//echo '<p><br><input type="button" name="back" value="Go Back" onclick="location.href=('index.php')"  /></p>';
//---------------------- 13/01/53
