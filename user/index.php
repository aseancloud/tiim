...
<form method="post" action="main.php">
	...
	<table style="width: 80%">
		<tr>
			...
			<td><strong>Welcome to www.tiimconference.org</strong></td>
		</tr>
		<tr>
			<td align="right">Username:</td>
			<td nowrap="nowrap"><input name="my_username" type="text" size="30" />
              <span class="form_hint">(email address)</span></td>
		</tr>
		<tr>
			<td align="right">Password:</td>
			<td><input name="my_password" type="password" size="30" /></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><input name="Submit1" type="submit" value="Login" />&nbsp;</td>
		</tr>
	</table></form>
...
-->
	...
	<form id="form2" name="form2" method="post" action="forgot_password.php">
	  &nbsp;&nbsp;&nbsp;&nbsp;  
	  <!--<div align="center">Forgot password, please e-mail password to me at -->
	      <div id="main_content"><h1>Checking Proceeding Status:</h1>
          <p>Please provide your e-mail then the status will be sent to you via e-mail.</p>
	    <label>
	    <input type="text" name="forgot_password" id="forgot_password" />
	    </label>
	    <label>
