...
<p class="h1"><b>Welcome <? echo $last_name,",&nbsp;",$first_name?>&nbsp;&nbsp;<? echo $username;//$_SESSION['my_username'];?></b><br />
...
?>   
    ...
    <form id="form3" name="form3" method="post" action="update_profile.php">
      <table align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
         <td>First name:</td>
          <!--<td><input size="30" name="first_name" value="<? echo $row['title'],"&nbsp;",$row['first_name'],"&nbsp;&nbsp;",$row['last_name'];?>"/></td> -->
		 <td><input size="21" name="first_name" value="<? echo $row['first_name'];?>"/>&nbsp;Last name:<input size="15" name="last_name" value="<? echo $row['last_name'];?>"/></td> 
        </tr>
		<!--
        <tr bgcolor="#F7F7F7">
          <td >Last name:</td>
        ...
        <tr bgcolor="#F7F7F7">
          <td>Institution:</td>
          <td><input id="institution" size="21" name="institution" value="<? echo $row['institution'];?>"/>
		   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Title:<input size="5" name="title" value="<? echo $row['title'];?>"/></td>
        </tr>
        <tr>
          <td>Address:</td>
          <td><input id="address" size="12" name="address" value="<? echo $row['address'];?>"/>&nbsp;City:<input id="city" size="12" name="city" value="<? echo $row['city'];?>"/>&nbsp;Postal code:<input id="postal_code" size="8" name="postal_code" value="<? echo $row['postal_code'];?>"/></td>
		  <!-- <td><input id="address" size="30" name="address" value="<? echo $row['address'],"&nbsp;",$row['city'],"&nbsp;",$row['postal_code'];?>"/></td>-->
        </tr>
		<!--
        <tr bgcolor="#F7F7F7">
          <td>City:</td>
        ...
        <tr bgcolor="#F7F7F7">
          <td>Phone:</td>
          <td><input id="phone" size="15" name="phone" value="<? echo $row['phone'];?>"/>&nbsp;Fax:<input id="fax" size="15" name="fax" value="<? echo $row['fax'];?>"/></td>
        </tr>
    <!--    <tr>
          <td>Fax:</td>
  ...
  <br />
  <hr />
 <!--<FORM NAME="aceButton"><INPUT TYPE="BUTTON" VALUE="upload" onClick="self.location.href=('main_uppaper.php')"></FORM> -->
  <span class="style1">Add Your New Papers </span><br/>
  To Add new Abstract / Papers <input type="submit" name="upload" value="upload" onClick="self.location.href=('main_uppaper.php')"  /><font color="#FF0000"><strong> (Maximun 2 Papers per 1 Register Name)</strong>  </font>
  <br />
  <hr />
   <!--==============================================================-->
    <table width="100%" cellspacing=0>
...
<?
  ...
  <?
  echo "<input type=\"submit\" name=\"Edit\"  value=\"Edit\" onclick=\"window.open('editpaper.php?papercode=$papercode','_blank','toolbar=0,location=0,directories=0,status=0,menubar=0,resizeable=0,scrollbars=1 ,height=500,width=600'); \"  />";
  ?>
 <font color="#FF0000">(To change paper / abstract click here)</font>
	<!-- <input type="submit" name="upload" value="upload" onClick="self.location.href=('main_uppaper.php')"  /> -->
    <br />
	...
	<?
		...
		while ($row4 = @mysql_fetch_assoc($result4)) {
			...
			echo '<td>'.$row4['institution_co'].'</td>';
			echo '<td>'.$row4['country_co'].'</td>';	
