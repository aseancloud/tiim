...
<?
  ...
  <?
  echo "<input type=\"submit\" name=\"Edit\"  value=\"Edit\" onclick=\"window.open('editpaper.php?papercode=$papercode','show','toolbar=0,location=0,directories=0,status=0,menubar=0,resizeable=0,scrollbars=1 ,height=500,width=600'); \"  />";
  ?>
