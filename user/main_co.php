...
<script language="JavaScript" type="text/javascript">
 ...
 function addNewRow() {
	...
	*/
	...
	td2.innerHTML = "<select id='title'"+index+" name='title[]' class='text'><option value='0'>-</option><option value='1'>Mr.</option>              <option value='2'>Ms.</option><option value='3'>Mrs.</option></select>";
	 ...
	 td5.innerHTML = "<input type='text' name='Telephone[]" + "'  id='Telephone" + index + "' value = '' size='10' maxlength='80' class='text'/>";
	 
	  var td6 = row.insertCell(5);		
	 td6.innerHTML = "<input type='text' name='email[]" + "'  id='email" + index + "' value = '' size='15' maxlength='80' class='text'/>";
...
<p class="h1"><b>Welcome <? echo $author;//$_SESSION['my_username'];?></b> </p>

  <br />
  <table width="100%" cellspacing=0>
	<tr>
		<td align="left" class="h2"><span class="style1">Co-author Papers Status</span></td>
		<td align="right" class="h2"><b><a href="logout.php"></a></b></td>
	</tr>
</table>
    <br />
	<?
	$sql = " SELECT ref_id FROM tiim_co_author WHERE email = '".$author."'";
	$result_co = @mysql_query($sql) or die(mysql_error());
	
	while ($row_co = @mysql_fetch_array($result_co)) {
	
		$sql = " SELECT * FROM tiim_paper WHERE id = '".$row_co['ref_id']."'";
		//echo  $sql;
		...
		<?
			...
			$sql4 = " SELECT * FROM tiim_co_author  WHERE ref_id = '".$row_co['ref_id']."'";
		...
		<?
			...
			$sql2 = " SELECT * FROM tiim_abstract_paper WHERE ref_id = '".$row_co['ref_id']."'";
		...
		<?
			...
			$sql3 = " SELECT * FROM tiim_full_paper WHERE ref_id = '".$row_co['ref_id']."'";
